...
<span class="blink">
<h3 align=center style="color: black"><c:out value="${msg}"/></h3>
</span>
...
<td><form:input type="text" path="emailid" required="text"/></td>
</tr>
...
<td><form:input path="username" required="text"/></td>
</tr>
...
<td><form:input path="contactno" required="text"/></td>
</tr>
