...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Online e-Visa Management System</a>
    ...
    <div class="container my-4">
        ...
        <div class="row featurette d-flex justify-content-center align-items-center">
            <div class="col-md-7">
                ...
                <p class="lead">Visa categories issued from indian government.e-Tourist,e-Business,e-Medical,e-Medical Attendant,e-Confrenece.
                Single Entry Visa,Multiple Entry Visa,Tourist Visa,Residence Visa,Work Visa,
